export interface SalonInfo {
    ...
    hours: {
        mondayToSaturday: { open: string; close: string; label: string };
        sunday: { open: null; close: null; label: string };
    };
}
...
export interface Service {
    id: string;
    category: string;
    professionalId: 'luciana-bezerra' | 'graziele-bezerra' | string;
...
export interface Product {
    ...
    name: string;
    brand: string;
    category: 'perfumes' | 'cabelo' | 'body-splash' | string;
    description: string;
    volume: string;
    price: number;
    badge?: string;
...
export const salonData: SalonData = {
    info: {
        name: "Glamour Studio",
        ...
        phone: "+55 (95) 98407-2160",
        phone2: "+55 (95) 98429-8305",
        whatsapp: "5595984072160",
        whatsappVendas: "5595984298305",
        ...
        heroImage: "/assets/images/hero-glamour-studio.jpg",
