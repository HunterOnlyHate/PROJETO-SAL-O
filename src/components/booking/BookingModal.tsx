    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="modal-header" style={{ flexShrink: 0, backgroundColor: '#FFFFFF', borderBottom: '1px solid #E5DFDC', position: 'relative' }}>
                    <div style={{ width: '100%' }}>
                        <div
                            style={{
                                width: '38px',
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
                            <div>
                                <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)', color: '#1C1819', margin: 0, fontWeight: 700 }}>
                                    Agendamento Online de Serviços
                                </h3>
                                <p style={{ fontSize: '0.8rem', color: '#524B4E', margin: '2px 0 0', fontWeight: 500 }}>
                ...
                {!confirmedAppointment && (
                    <div style={{ flexShrink: 0, backgroundColor: '#FAF7F5', borderBottom: '1px solid #E5DFDC', padding: '0.6rem 1.1rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '5px', fontSize: '0.78rem', fontWeight: 700, color: '#A68037' }}>
                            <span>
                            ...
                            <span style={{ color: '#524B4E', fontWeight: 600 }}>{Math.round((currentStep / totalSteps) * 100)}%</span>
                        </div>
                ...
                {/* Modal Body */}
                <div className="modal-body" style={{ flex: '1 1 auto', overflowY: 'auto', padding: '1.5rem 1.75rem' }}>
                    ...
                    {confirmedAppointment ? (
                        <div style={{ textAlign: 'center', padding: '1rem 0.5rem' }}>
                            ...
                            <h3 style={{ fontSize: '1.4rem', fontWeight: 700, margin: '0 0 0.5rem', color: '#1C1819' }}>
                                {confirmedAppointment.isDual ? 'Agendamentos Combinados Registrados com Sucesso!' : 'Agendamento Registrado com Sucesso!'}
                            </h3>
                            <p style={{ color: '#524B4E', fontSize: '0.92rem', maxWidth: '520px', margin: '0 auto 1.5rem' }}>
                            ...
                            >
                                <div><strong>Cliente:</strong> {clientName} ({clientPhone})</div>
                                <div><strong>Data do Atendimento:</strong> {selectedDate.split('-').reverse().join('/')}</div>

                                {confirmedAppointment.isDual ? (
                                    <>
                                        <div style={{ padding: '10px 14px', background: '#FFF5F7', borderRadius: '10px', borderLeft: '4px solid #9B2C4D', border: '1px solid #F3C5D1', borderLeftWidth: '4px' }}>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '4px' }}>
                                                <span style={{ fontWeight: 700, color: '#8A1C3E', fontSize: '0.92rem' }}>💇‍♀️ Luciana Bezerra (Cabelos & Unhas)</span>
                                                {confirmedAppointment.lucianaAppointmentId && (
                                                    <span style={{ fontSize: '0.76rem', fontWeight: 700, background: '#F3C5D1', color: '#8A1C3E', padding: '2px 6px', borderRadius: '4px' }}>
                                                        #{confirmedAppointment.lucianaAppointmentId.slice(-6).toUpperCase()}
                                                    </span>
                                                )}
                                            </div>
                                            <div style={{ marginTop: '2px', color: '#1C1819' }}>Horário: <strong>{lucianaTime} às {lucianaEndTime}</strong> (⏱️ {lucianaDurationFormatted})</div>
                                            <div style={{ fontSize: '0.82rem', color: '#524B4E', marginTop: '2px' }}>Procedimentos: {lucianaServices.map((s) => s.name).join(', ')}</div>
                                        </div>

                                        <div style={{ padding: '10px 14px', background: '#FFF8FA', borderRadius: '10px', borderLeft: '4px solid #A33B6E', border: '1px solid #F5CEDB', borderLeftWidth: '4px' }}>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '4px' }}>
                                                <span style={{ fontWeight: 700, color: '#922B5C', fontSize: '0.92rem' }}>🌸 Graziele Bezerra (Sobrancelhas & Depilação)</span>
                                                {confirmedAppointment.grazieleAppointmentId && (
                                                    <span style={{ fontSize: '0.76rem', fontWeight: 700, background: '#F5CEDB', color: '#922B5C', padding: '2px 6px', borderRadius: '4px' }}>
                                                        #{confirmedAppointment.grazieleAppointmentId.slice(-6).toUpperCase()}
                                                    </span>
                                                )}
                                            </div>
                                            <div style={{ marginTop: '2px', color: '#1C1819' }}>Horário: <strong>{grazieleTime} às {grazieleEndTime}</strong> (⏱️ {grazieleDurationFormatted})</div>
                                            <div style={{ fontSize: '0.82rem', color: '#524B4E', marginTop: '2px' }}>Procedimentos: {grazieleServices.map((s) => s.name).join(', ')}</div>
                                        </div>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <div><strong>Procedimento(s):</strong> {chosenServices.map((s) => s.name).join(', ')}</div>
                                    </>
                                )}

                                <div style={{ borderTop: '1px solid #E5DFDC', paddingTop: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <span style={{ fontWeight: 600, color: '#524B4E' }}>Valor Estimado:</span>
                                    <span style={{ color: '#A68037', fontWeight: 800, fontSize: '1.1rem' }}>{priceDisplay}</span>
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'flex', gap: '0.8rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                                ...
                                {confirmedAppointment.isDual && (
                                    <>
                                        <a
                                            ...
                                            style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', backgroundColor: '#FFFFFF', color: '#8A1C3E', border: '1.5px solid #F3C5D1', fontWeight: 700 }}
                                        >
                                            💇‍♀️ WhatsApp Luciana
                                        </a>
                                        <a
                                            ...
                                            rel="noopener noreferrer"
                                            className="btn btn-secondary btn-sm"
                                            style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', backgroundColor: '#FFFFFF', color: '#922B5C', border: '1.5px solid #F5CEDB', fontWeight: 700 }}
                                        >
                                            🌸 WhatsApp Graziele
                                        </a>
                                    </>
                                ...
                                <button
                                    ...
                                    onClick={handleClose}
                                    style={{ backgroundColor: '#FAF7F5', color: '#1C1819', border: '1px solid #E5DFDC' }}
                                >
                                    Concluir & Fechar
                                </button>
                            </div>
                        ...
                        <>
                            ...
                            <div className={`step-container ${currentStep === 1 ? 'active' : ''}`} id="step1">
                                <h4 className="step-title" style={{ color: '#1C1819', fontWeight: 700 }}>1. Escolha o(s) Procedimento(s)</h4>
                                <p className="step-subtitle" style={{ color: '#524B4E' }}>
                                ...
                                {selectedServices.length > 0 && (
                                    <div id="modalSelectedAlert" className="modal-selected-alert" style={{ display: 'flex', flexDirection: 'column', gap: '4px', backgroundColor: '#FAF6EE', border: '1.5px solid #DFC79B', padding: '0.85rem 1rem', borderRadius: '12px', marginBottom: '1rem' }}>
                                        <div className="modal-selected-alert-text" style={{ color: '#1C1819', fontSize: '0.9rem' }}>
                                            ✨ <strong>{selectedServices.length} serviço(s) selecionado(s)</strong> • Duração estimada: <strong>{durationFormatted}</strong> • Total: <strong style={{ color: '#A68037' }}>{priceDisplay}</strong>
                                        </div>
                                        {isDual && (
                                            <div style={{ fontSize: '0.8rem', color: '#2B8A3E', fontWeight: 700 }}>
                                ...
                                <div className="modal-quick-combos" style={{ backgroundColor: '#FAF7F5', border: '1px solid #E5DFDC', padding: '0.75rem 0.9rem', borderRadius: '12px', marginBottom: '0.85rem' }}>
                                    <div className="modal-quick-combos-title" style={{ color: '#1C1819', fontWeight: 700, fontSize: '0.82rem', marginBottom: '6px' }}>
                                        <span>💡</span> Sugestões para adicionar com 1 clique:
                                    </div>
                                    <div className="modal-combos-chips">
                                        <button
                                            type="button"
                                ...
                                <div className="modal-services-select" id="modalServicesList">
                                    {salonData.services
                                        .filter((s) => {
                                        ...
                                        .map((service) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="modal-service-left">
                                                        <div className="modal-service-name" style={{ color: '#1C1819', fontWeight: 600 }}>
                                                            <span>{isSelected ? '✓ ' : ''}{service.name}</span>
                                                        </div>
                                                        <div className="modal-service-pro" style={{ color: '#524B4E' }}>
                                                            {proIcon} {service.professionalName} • ⏱️ {service.duration}
                                                        </div>
                                                    </div>
                                                    <div className="modal-service-price" style={{ color: '#A68037', fontWeight: 700 }}>
                            ...
                            <div className={`step-container ${currentStep === 2 ? 'active' : ''}`} id="step2">
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.4rem' }}>
                                    <h4 className="step-title" style={{ margin: 0, color: '#1C1819', fontWeight: 700 }}>
                                        2. {isDual ? 'Agendas de Luciana & Graziele' : 'Data & Horário de Atendimento'}
                                    </h4>
                                    <button type="button" className="btn-change-services" onClick={() => setCurrentStep(1)}>
                                        ✏️ + Adicionar/trocar procedimentos
                                    </button>
                                </div>
                                ...
                                <div className="form-group" style={{ marginBottom: '1.25rem' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '6px', marginBottom: '6px' }}>
                                        <label className="form-label" htmlFor="bookingDate" style={{ margin: 0, color: '#1C1819', fontWeight: 700 }}>
                                            📅 Data do Atendimento:
                                        </label>
                                        {selectedDate && (
                                    ...
                                    <input
                                        ...
                                        style={{ fontSize: '0.95rem', backgroundColor: '#FFFFFF', color: '#1C1819', border: '1.5px solid #C5A059', fontWeight: 600 }}
                                    />
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '4px', marginTop: '4px' }}>
                                        <span style={{ fontSize: '0.8rem', color: '#524B4E' }}>
                                            Formato: <strong>DD/MM/AAAA</strong> • Funcionamento de Segunda a Sábado das 10h às 18h.
                                        </span>
                                    </div>
                                </div>
                                ...
                                {isDual ? (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                                        ...
                                        >
                                            <div style={{ fontWeight: 700, color: '#A68037', marginBottom: '3px', display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.92rem' }}>
                                                <span>✨</span> Agendamento Duplo Anti-Conflito
                                            </div>
                                            <div style={{ color: '#524B4E', fontSize: '0.82rem', lineHeight: 1.4 }}>
                                                Ao marcar o horário da 1ª profissional, a agenda da 2ª bloqueará horários sobrepostos para você, liberando apenas atendimentos em sequência ou horários livres.
                                            </div>
                                        ...
                                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
                                            ...
                                            >
                                                <div>
                                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '6px' }}>
                                                        <span style={{ fontWeight: 800, color: '#8A1C3E', fontSize: '0.98rem' }}>
                                                            💇‍♀️ 1. Luciana Bezerra
                                                        </span>
                                                        <span style={{ fontSize: '0.74rem', background: '#FBE0E7', color: '#8A1C3E', padding: '3px 8px', borderRadius: '6px', fontWeight: 700 }}>
                                                            ⏱️ {lucianaDurationFormatted}
                                                        </span>
                                                    </div>
                                                    <div style={{ fontSize: '0.8rem', color: '#524B4E', marginTop: '2px', fontWeight: 500 }}>
                                                ...
                                                {!isLucianaDayOpen ? (
                                                    <div style={{ padding: '0.85rem', background: '#FFF5F5', color: '#C92A2A', borderRadius: '8px', fontSize: '0.82rem', textAlign: 'center', fontWeight: 600, border: '1px solid #FFA8A8' }}>
                                                        🔒 {lucianaClosedReason || 'Indisponível nesta data'}
                                                    </div>
                                                ) : isLoadingLucianaSlots ? (
                                                    <div style={{ fontSize: '0.84rem', color: '#A68037', textAlign: 'center', padding: '1rem', fontWeight: 600 }}>
                                                        🔄 Buscando agenda da Luciana...
                                                    </div>
                                                ) : (
                                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(100%, 75px), 1fr))', gap: '6px', maxHeight: '170px', overflowY: 'auto' }}>
                                                        {filteredLucianaSlots.map((slot) => {
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    <div>{slot.time}</div>
                                                                    <div style={{ fontSize: '0.66rem', opacity: isSelected ? 0.95 : 0.75, fontWeight: 500 }}>
                                                ...
                                                {lucianaTime && (
                                                    <div style={{ fontSize: '0.8rem', color: '#0F5132', fontWeight: 700, background: '#E6F7ED', padding: '4px 8px', borderRadius: '6px', border: '1px solid #A3E635' }}>
                                            ...
                                            >
                                                <div>
                                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '6px' }}>
                                                        <span style={{ fontWeight: 800, color: '#922B5C', fontSize: '0.98rem' }}>
                                                            🌸 2. Graziele Bezerra
                                                        </span>
                                                        <span style={{ fontSize: '0.74rem', background: '#FCE4ED', color: '#922B5C', padding: '3px 8px', borderRadius: '6px', fontWeight: 700 }}>
                                    ...
                                    <div className="form-group custom-time-wrapper">
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                                            <label className="form-label" style={{ margin: 0, color: '#1C1819', fontWeight: 700 }}>
                                                🕒 Horários Livres para {hasLuciana ? 'Luciana Bezerra' : 'Graziele Bezerra'} ({durationFormatted}):
                                            </label>
                                            {isLoadingSlots && (
                                                <span style={{ fontSize: '0.8rem', color: '#A68037', fontWeight: 700 }}>
                                                    🔄 Atualizando agenda...
                                                </span>
                                            )}
                                        </div>
                                        ...
                                        {!isDayOpen ? (
                                            ...
                                            <div style={{ padding: '1.25rem', textAlign: 'center', color: '#524B4E', fontSize: '0.9rem', background: '#FAF7F5', borderRadius: '10px', border: '1px solid #E5DFDC' }}>
                                            ...
                                            <div style={{ marginTop: '0.6rem' }}>
                                                <div
                                                    style={{
                                                        display: 'grid',
                                                        gridTemplateColumns: 'repeat(auto-fill, minmax(min(100%, 105px), 1fr))',
                                                        gap: '0.55rem',
                                                    }}
                                                >
                                                        ...
                                                        return (
                                                            <button
                                                                ...
                                                                style={{
                                                                    ...
                                                                    alignItems: 'center',
                                                                    gap: '2px',
                                                                    boxShadow: isSelected ? '0 4px 12px rgba(197, 160, 89, 0.35)' : 'none',
                                                                }}
                                                            >
                                                                <span>{slot.time}</span>
                            ...
                            <div className={`step-container ${currentStep === 3 ? 'active' : ''}`} id="step3">
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.4rem' }}>
                                    <h4 className="step-title" style={{ margin: 0, color: '#1C1819', fontWeight: 700 }}>3. Identificação do Agendamento</h4>
                                    <button type="button" className="btn-change-services" onClick={() => setCurrentStep(1)}>
                                        ✏️ Alterar procedimentos
                                    </button>
                                </div>
                                <p className="step-subtitle" style={{ color: '#524B4E' }}>Informe seu nome e WhatsApp para registro e confirmação dos horários.</p>

                                <div className="form-group">
                                    <label className="form-label" htmlFor="clientName" style={{ color: '#1C1819', fontWeight: 700 }}>Seu Nome Completo *</label>
                                    <input
                                        type="text"
                                        id="clientName"
                                        className="form-control"
                                        ...
                                        style={{ backgroundColor: '#FFFFFF', color: '#1C1819', border: '1.5px solid #E5DFDC', fontWeight: 500, fontSize: '16px', minHeight: '46px' }}
                                    />
                                </div>

                                <div className="form-group">
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '6px', marginBottom: '8px' }}>
                                        <label className="form-label" htmlFor="clientPhone" style={{ margin: 0, color: '#1C1819', fontWeight: 700 }}>
                                    ...
                                    <input
                                        ...
                                        style={{ backgroundColor: '#FFFFFF', color: '#1C1819', border: '1.5px solid #E5DFDC', fontWeight: 600, fontSize: '16px', minHeight: '46px' }}
                                    />
                                ...
                                <div className="form-group">
                                    <label className="form-label" htmlFor="clientNotes" style={{ color: '#1C1819', fontWeight: 700 }}>Observações (opcional)</label>
                                    <textarea
                                        id="clientNotes"
                                        className="form-control"
                                        rows={2}
                                        placeholder="Ex: Primeira vez no salão, preferência de esmalte, etc..."
                                        value={clientNotes}
                                        onChange={(e) => setClientNotes(e.target.value)}
                                        style={{ backgroundColor: '#FFFFFF', color: '#1C1819', border: '1.5px solid #E5DFDC', fontWeight: 500, fontSize: '16px' }}
                                    ></textarea>
                                </div>
                            </div>
                            ...
                            <div className={`step-container ${currentStep === 4 ? 'active' : ''}`} id="step4">
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.4rem' }}>
                                    <h4 className="step-title" style={{ margin: 0, color: '#1C1819', fontWeight: 700 }}>4. Resumo do Agendamento</h4>
                                    <button type="button" className="btn-change-services" onClick={() => setCurrentStep(1)}>
                                        ✏️ + Adicionar/trocar serviços
                                    </button>
                                </div>
                                <p className="step-subtitle" style={{ color: '#524B4E' }}>Revise os detalhes abaixo antes de confirmar o agendamento.</p>

                                <div className="booking-summary-card" style={{ backgroundColor: '#FAF7F5', border: '1.5px solid #E5DFDC', color: '#1C1819' }}>
                                    <div className="summary-row">
                                        <span style={{ color: '#524B4E', fontWeight: 600 }}>Cliente:</span>
                                        <strong style={{ color: '#1C1819' }}>{clientName} ({clientPhone})</strong>
                                    </div>
                                    <div className="summary-row">
                                        <span style={{ color: '#524B4E', fontWeight: 600 }}>Data:</span>
                                        <strong style={{ color: '#A68037', fontWeight: 800 }}>
                                    ...
                                    {isDual ? (
                                        <>
                                            <div className="summary-row" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '4px', background: '#FFF5F7', padding: '10px', borderRadius: '8px', borderLeft: '3px solid #9B2C4D' }}>
                                                <span style={{ fontWeight: 800, color: '#8A1C3E' }}>💇‍♀️ 1. Luciana Bezerra ({lucianaTime} às {lucianaEndTime}):</span>
                                                <div style={{ paddingLeft: '10px', fontSize: '0.86rem', color: '#1C1819' }}>
                                                    {lucianaServices.map((s) => (
                                                        <div key={s.id}>• {s.name} {s.price > 0 ? `(R$ ${s.price.toFixed(2).replace('.', ',')})` : ''}</div>
                                                    ))}
                                                </div>
                                            </div>

                                            <div className="summary-row" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '4px', background: '#FFF8FA', padding: '10px', borderRadius: '8px', borderLeft: '3px solid #A33B6E' }}>
                                                <span style={{ fontWeight: 800, color: '#922B5C' }}>🌸 2. Graziele Bezerra ({grazieleTime} às {grazieleEndTime}):</span>
                                                <div style={{ paddingLeft: '10px', fontSize: '0.86rem', color: '#1C1819' }}>
                                        ...
                                        <>
                                            <div className="summary-row">
                                                <span style={{ color: '#524B4E', fontWeight: 600 }}>Especialista:</span>
                                                <strong style={{ color: '#1C1819' }}>{hasLuciana ? 'Luciana Bezerra' : 'Graziele Bezerra'}</strong>
                                            </div>
                                            <div className="summary-row">
                                                <span style={{ color: '#524B4E', fontWeight: 600 }}>Horário:</span>
                                                <strong style={{ color: '#A68037', fontWeight: 800 }}>
                                                    {selectedTime} às {singleEndTime}
                                                </strong>
                                            </div>
                                            <div className="summary-row">
                                                <span style={{ color: '#524B4E', fontWeight: 600 }}>Procedimento(s):</span>
                                                <div style={{ textAlign: 'right', fontWeight: 600, color: '#1C1819' }}>
                                            ...
                                            <div className="summary-row">
                                                <span style={{ color: '#524B4E', fontWeight: 600 }}>Duração Estimada:</span>
                                                <span style={{ color: '#1C1819' }}>{durationFormatted}</span>
                                            </div>
                                        </>
                                    )}

                                    <div className="summary-row total" style={{ borderTop: '2px solid #E5DFDC', paddingTop: '10px', marginTop: '6px' }}>
                                        <span style={{ fontWeight: 700, color: '#1C1819', fontSize: '1rem' }}>Investimento Total Estimado:</span>
                                        <span id="summaryTotalPrice" style={{ color: '#A68037', fontWeight: 800, fontSize: '1.2rem' }}>
                                            {priceDisplay}
                                        </span>
                                    </div>
                                </div>

                                <div style={{ marginTop: '1.2rem', fontSize: '0.84rem', color: '#524B4E', textAlign: 'center', fontWeight: 500 }}>
                ...
                {!confirmedAppointment && (
                    <div
                        ...
                        style={{
                            ...
                            padding: '0.85rem 1.25rem calc(0.85rem + env(safe-area-inset-bottom, 10px)) 1.25rem',
                            display: 'flex',
                    ...
                    >
                        {currentStep > 1 ? (
                            <button
                                ...
                                style={{ backgroundColor: '#FFFFFF', color: '#1C1819', border: '1.5px solid #E5DFDC', fontWeight: 600, minHeight: '44px', padding: '0.5rem 1.2rem' }}
                            >
                                ← Voltar
                            </button>
                        ) : (
                        ...
                        {currentStep < totalSteps ? (
                            <button
                                ...
                                id="modalNextBtn"
                                onClick={handleNext}
                                style={{ backgroundColor: '#C5A059', color: '#FFFFFF', fontWeight: 700, minHeight: '44px', padding: '0.5rem 1.4rem' }}
                            >
                                Avançar →
                            </button>
                        ) : (
                            <button
                                ...
                                disabled={isSubmitting}
                                style={{ padding: '0.65rem 1.4rem', fontWeight: 700, minHeight: '44px' }}
                            >
